...
dependencies {
    ...
    implementation("com.fasterxml.jackson.dataformat:jackson-dataformat-xml:[2.11,2.12-alpha)")
    implementation("com.fasterxml.jackson.core:jackson-databind:[2.11,2.12-alpha)")
    implementation("com.fasterxml.jackson.core:jackson-annotations:[2.11,2.12-alpha)")
    implementation("com.fasterxml.jackson.core:jackson-core:[2.11,2.12-alpha)")
    implementation("org.codehaus.woodstox:woodstox-core-asl:[4.1,4.2-alpha)")
}
