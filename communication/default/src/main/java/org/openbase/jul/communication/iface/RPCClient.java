 ...
 */
public interface RPCClient extends RPCCommunicator {

    double getTimeout() throws NotAvailableException;

    Future<org.openbase.type.communication.EventType.Event> callAsync(String name, Event event);
    ...
    Event call(String name, org.openbase.type.communication.EventType.Event event) throws CouldNotPerformException, InterruptedException;
