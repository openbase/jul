...
/**
 * Exception indicating that somebody tried to perform an action
 * without having the appropriate permissions.
 *
 * @author <a href="mailto:cromankiewicz@techfak.uni-bielefeld.de">Constantin Romankiewicz</a>
 */
public class PermissionDeniedException extends CouldNotPerformException {
