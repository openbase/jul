...
public class RegisterNetworkResourceListenerCommand extends AbstractCommand {
	 ...
	 * JSON Constructor
	 */
	private RegisterNetworkResourceListenerCommand() {
	}
	
	public RegisterNetworkResourceListenerCommand(ResourceKey resourceKey) {
