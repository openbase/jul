...
public class RemoveNetworkResourceListenerCommand extends AbstractCommand {
	 ...
	 * JSON Constructor
	 */
	private RemoveNetworkResourceListenerCommand() {
	}
	
	public RemoveNetworkResourceListenerCommand(ResourceKey resourceKey) {
